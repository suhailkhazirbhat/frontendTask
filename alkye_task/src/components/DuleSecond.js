    ...
    return (
        <>
                ...
                <div className='second-section'>
                    ...
                    <br></br>
                    <br></br>
                   <div ><img src={icon1} className='sidetexticon' />  <h3 style={{display:'inline',fontFamily:'Oswald'}}>Quarterly Business Updates</h3></div>
                   <br></br>
                    <p style={{fontFamily:'Inter'}}>We strive to stay connected as a team through communication and collaboration. This materialises every quarter through our Quarterly Business Update events. These gatherings are immersive sessions where every team
