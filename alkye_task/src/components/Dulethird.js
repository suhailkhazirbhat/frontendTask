                ...
                <div style={{
                    ...
                    <div style={{ display: 'inline', width: '100%' }}>
                        <div style={{
                            ...
                            <h1 style={{ fontFamily: 'Oswald' }}>We believe in   <span style={{ color: '#F36F2B' }}> diversity & inclusion</span></h1>
                        </div>
                    </div>
                    <div style={{ display: 'inline', color: 'white', fontSize: '9px', width: '%100' }}>
                        <div style={{ margin: '5%' }}>
                            <p style={{ fontFamily: 'Inter' }}>At CaSE we do not just accept difference — we celebrate it, we support it, and we thrive on it for the benefit of our employees, our services, our industry and our community. We are proud to be an equal opportunity
